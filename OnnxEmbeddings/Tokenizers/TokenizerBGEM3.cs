...
{
    public class TokenizerBGEM3
    {
        private TokenizerBGEM3()
        {
            LoadTokenizer("bge-m3-vocab.json");
        }
        ...
        private static TokenizerBGEM3? _Instance;
        public static TokenizerBGEM3 Instance
        {
            get
            {
                lock (locker)
        ...
        public TokenizationResult Tokenize(string[] sentences, string vocabPath = null)
        {
                    ...
                    else
                    {
                        ...
                        while (word != "")
                        {
                            for (int a = word.Length - 1; a > 0; a--)
                            {
                                ...
                                string subword = first == false ? sub : $"▁{sub}";
            ...
            if (same == false)
            {
                ...
                for (int i = 0; i < tokenResult.input_ids.Length; i++)
                {
                    ...
                    long[] input_ids_buffered = ones_like(max);
